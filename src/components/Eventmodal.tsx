...
export default function EventModal({ initialDate, event, onSave, onDelete, onClose, onEdit, readOnly, universityLocation }: Props) {
    ...
    const handleSave = () => {
        ...
        if (locInput && !locValidated) {
            toast(
                "Seleccioná una ubicación de la lista para que se pueda usar en el mapa",
                "error"
            )
            return
        }
        onSave?.({
            ...
            location: locValidated ? locInput : '',
        })
    }
    ...
    return (
        <div className="evm-overlay" onClick={e => e.target === e.currentTarget && onClose()}>
            <div className="evm-modal" style={{ '--evm-accent': form.color } as React.CSSProperties}>
                ...
                <div className="evm-header">
                    ...
                    <div className="evm-header-content">
                        <div className="evm-header-top">
                            ...
                            <button className="evm-close" onClick={onClose}><X size={16} /></button>
                        </div>
                        <input
                            ref={titleRef}
                                ...
                                {form.graded && (
                                    <div className="evm-grade-input-wrap">
                                        ...
                                        <div className="evm-grade-field">
                                            ...
                                            />
                                            {form.grade != null && (
                                                <span className="evm-grade-badge" style={{ background: gradeColor + '22', color: gradeColor, borderColor: gradeColor + '44' }}>
                    ...
                    <div className="evm-section">
                        ...
                        <div className="evm-location-autocomplete" ref={locRef}>
                            <div className={`evm-location-field${locValidated ? ' evm-location-field--valid' : locInput.length > 0 ? ' evm-location-field--typing' : ''}`}>
                                ...
                                {locValidated && (
                                    <span className="evm-loc-check" title="Ubicación verificada"><CheckCircle size={12} style={{ position: "relative", top: "2" }} /></span>
                                )}
                                {locInput && (
                ...
                <div className="evm-footer">
                    {readOnly ? (
                        ...
                        <>
                            ...
                            <button type="button" className="evm-btn" onClick={onClose}>
                                Cancelar
                            </button>
